    ...
    return (
        <header className='header'>
            ...
            <div className={`${adminLogin ? 'admin-header-navigation' : 'header-navigation'}`}>
                ...
                <li className='navigation-option'><Link to="/shopping-basket" className="navigation-option"><i className="fa-solid fa-bag-shopping"></i>{login == true && <div className="basket-in-product-number">{cartProducts.length}</div>}</Link></li>
